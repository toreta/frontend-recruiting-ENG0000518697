...
describe("UserFormTemplate test", () => {
  ...
  describe("バリデーションチェック", () => {
    it("氏名が未入力の場合、エラーメッセージが表示されること", () => {});
    it("Eメールが未入力の場合、エラーメッセージが表示されること", () => {});
    it("郵便番号が未入力の場合、エラーメッセージが表示されること", () => {});
    it("都道府県が未選択の場合、エラーメッセージが表示されること", () => {});
    it("市区町村が未入力の場合、エラーメッセージが表示されること", () => {});
    it("住所の建物・号室が未入力の場合、エラーメッセージが表示されないこと", () => {});
  });
